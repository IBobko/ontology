...
Копия sync-клиента хранится в `tools/wp`, потому что приватный GitHub-
репозиторий не может напрямую использовать action из другого приватного
репозитория личного аккаунта. WordPress-плагин хранится в
`IBobko/deconreality`.
